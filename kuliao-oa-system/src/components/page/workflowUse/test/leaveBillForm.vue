        ...
        <div class="container">
            <div class="form-box">
                ...
                <el-form :disabled="readonly" :rules="rules" ref="ruleForm" :model="ruleForm" label-width="102px">
                    ...
                    <!--请假时间start-->
                    <date-and-time v-model="ruleForm.leaveTimeList" :msg="!readonly" ref="dateAndTime" class="label-width"></date-and-time>
                    <!--请假时间end-->
                    ...
                    <el-button @click="onSubmit('ruleForm')">测试</el-button>
                </el-form>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$axios.get("static/flow.json").then((res) => {
