<template>
    <div class="table">
        ...
        <el-row type="flex" justify="center">
            ...
            <!--table-->
            <!--form-->
            <el-col :span="!readonly?9:24">
                <div class="container">
                    <el-form :disabled="readonly" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
                        ...
                        <el-form-item label="申请事由">
                            <el-input style="width: 50%" type="textarea" v-model="ruleForm.meetingCause" rows="5"></el-input>
                        </el-form-item>
                        <el-form-item label="备注">
                            <el-input style="width: 50%" type="textarea" v-model="ruleForm.meetingRemark" rows="4"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
            </el-col>
        ...
        methods: {
            ...
            handleSelectionChange(row) { //对选中的数据进行判断
                ...
                if (row !== undefined || row !== '') {
                    ...
                    that.ruleForm.meetingTime = that.getNowTime(); //todo 申请日期，调用时机
