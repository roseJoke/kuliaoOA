            ...
            <el-col class="table-padding">
                <el-table
                    ...
                    <el-table-column
                        ...
                        align="center">
                        <template slot-scope="scope">
                            <el-input @change="checkManHour" size="small" v-model="scope.row.manHour"  placeholder="请输入工时"></el-input>
                        </template>
                    </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            checkManHour() {
                if(this.askForLeaveTime.manHour !== undefined || this.askForLeaveTime.manHour !== '') {
                    this.index = '';
                };
            },
        }
