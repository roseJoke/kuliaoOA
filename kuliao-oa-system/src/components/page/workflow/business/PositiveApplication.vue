    ...
    export default {
        ...
        methods: {
            ...
            search() { //查询员工档案
                ...
                that.$axios.post('/hr/archives/emp/',param).then((res) => {
                    console.log('获取员工档案信息:');
                    console.log(res);
                    this.$set(that.ruleForm,'staffId',res.data.data.list[0].empno);
                    this.$set(that.ruleForm,'staffName',res.data.data.list[0].name);
                    this.$set(that.ruleForm,'department',res.data.data.list[0].dept);
                    this.$set(that.ruleForm,'postTitle',res.data.data.list[0].postName);
                    this.$set(that.ruleForm,'entryTime',res.data.data.list[0].entryDate);
                });
            },
            resetForm(formName) {
