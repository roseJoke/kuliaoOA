<template>
    <div>
        <router-view v-model="data" ref="form" :readonly="false"></router-view>
...
<script>
    import queryStep from './approver.vue'
    export default {
        data() {
            return {
                data: {},
            ...
            submitForm(formName) { //提交
                ...
                form.validate((valid) => {
                    if (valid) {
                        ...
                        console.log(that.$refs.form.ruleForm);
                        this.$axios.post("/workflow/activate/initiate", {
                            ...
                            that.$router.push("/work/forMySend");
                        });
                    } else {
