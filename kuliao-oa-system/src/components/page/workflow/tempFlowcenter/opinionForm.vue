        ...
        <div class="form-box">
            ...
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-row type="flex" class="row-bg padding-style">
                    ...
                    <el-col :span="4" :pull="1">
                        <el-form-item label="请假人">
                            <el-input class="input-width disabled-style" :disabled="true"
                                      v-model="form.empName"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5" :offset="1">
                        <el-form-item label="所属部门">
                            <el-input class="input-width disabled-style" :disabled="true"
                                      v-model="form.businessData[0].department"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <!--请假时间start-->
                ...
                <el-form-item class="date-width" label="共计">
                    <el-col :span="5">
                        <el-form-item>
                            <el-input class="input-day-width" v-model="form.businessData[0].days"
                    ...
                    <el-col :span="5">
                        <el-form-item>
                            <el-input class="input-day-width" v-model="form.businessData[0].times"
                                      :disabled="true"></el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-form-item label="请假类型">
                    <el-radio-group v-model="form.businessData[0].leaveType">
                        <el-radio v-for="item in radio" :key="item" :label="item" :disabled="true"
                                  class="disabled-style">{{item}}
                        </el-radio>
                    </el-radio-group>
                </el-form-item>

                <el-form-item label="请假事由">
                    <el-input class="textarea-width disabled-style" type="textarea" rows="10"
                              v-model="form.businessData[0].reason" :disabled="true"></el-input>
                </el-form-item>
            </el-form>
            <br>
            <div class="crumbs">
            ...
            <el-row>
                <el-col :span="12">
                    <div class="div-opinion-demo">
                        <div v-for="item in opinionHis" class="div-opinion">
                            <!--审批历史table start-->
                            <br>
                            <h5>{{ item.name }}&nbsp({{ item.time }})</h5>
                            <br>
                            <h5>{{ item.opinion }}</h5>
                            <hr class="hr-style">
                            <!--审批历史table end-->
                ...
                <!--审批-->
                <el-col :span="12">
                    <el-form :rules="rules" :inline-message="true" ref="opinion" :model="opinion" label-width="100px">
                        ...
                        <el-form-item>
                            ...
                            <el-button type="primary" :round="true" @click="resetForm('opinion')">取消</el-button>
                        </el-form-item>
                    </el-form>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created(){
            let that = this;
            if (that.$router.params.handler!=undefined){
                // 就将其保存
            }
